...
TableViewCell *myCell=(TableViewCell*)[tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
    myCell.labelone.text=[firstLabelArray objectAtIndex:indexPath.row];
    myCell.labeltwo.text=[secondLabelArray objectAtIndex:indexPath.row];
    myCell.imgView.image=[UIImage imageNamed:[imagesArray objectAtIndex:indexPath.row]];
    return myCell;
}
